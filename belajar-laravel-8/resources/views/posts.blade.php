      ...
      <div class="card mb-3">
        @if($posts[0]->image)
          <div style="max-height:400px; overflow:hidden;">
            <img src="{{ asset('storage/' . $posts[0]->images) }}{{ $posts[0]->category->name }}" alt="{{ $post->category->name }}" class="img-fluid">
          </div>
        @else
  ...
  <div class="row">
    ...
    <div class="col-md-4 mb-3">
      <div class="card">
        ...
        @if($post->image)
          <img src="{{ asset('storage/' . $post->images) }}{{ $post->category->name }}" alt="{{ $post->category->name }}" class="img-fluid">
        @else
